...
const NewConcept = () => {
  return (
    <div className="bg-white/90  xl:2/3 mx-auto">
      <div className=" ">
        <div className="">
          ...
          <h3 className=" font-serif text-center text-xl md:text-4xl lg:text-5xl font-[600] mt-5 text-black/90">
            Earn your badge and get interact more.
          </h3>
          <div className="flex mt-10 w-2/3 mx-auto justify-between flex-wrap md:flex-nowrap">
            <div className="flex items-center flex-wrap md:flex-nowrap">
              <div>
                ...
                <div className="flex gap-4 mt-10">
                  <MdSpaceDashboard className="text-5xl lg:text-8xl"></MdSpaceDashboard>
                  <div>
                    {" "}
            ...
            <img
              className="w-2/3 mx-auto hover:-translate-y-1 hover:scale-105 duration-300  "
              src={brainImage}
              alt=""
            />
          </div>
        </div>
        <div className=" w-11/12 mx-auto grid grid-cols-1 lg:grid-cols-3 gap-5  py-20">
